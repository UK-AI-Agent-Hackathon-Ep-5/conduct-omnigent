 ...
 * owned by the web layer. This fills its center with "Conduct — <host>" and
 ...
 *
 * When a thread is open, its title replaces the "Conduct" brand label
...
export function TitleBarServerPicker({
  ...
  /** Title of the currently open thread, or null/undefined when no thread
      is selected or it has no title yet (falls back to "Conduct"). */
      ...
      <DropdownMenu>
        ...
        >
          <span className="truncate font-medium">
            {threadTitle || "Conduct"} — {hostOf(info.currentOrigin)}
          </span>
