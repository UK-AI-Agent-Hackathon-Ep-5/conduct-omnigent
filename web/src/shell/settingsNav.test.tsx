...
// (max-md:hidden), and "Back to Conduct" does NOT close the sidebar overlay
...
describe("SettingsSidebarBody", () => {
  ...
  it("does NOT close the sidebar when 'Back to Conduct' is tapped", () => {
    ...
    fireEvent.click(screen.getByRole("link", { name: /Back to Conduct/ }));
