...
2. Run the scanner:
   ```
   python3 examples/impact-radar/scripts/scan_code.py \
...
4. Cross-reference `data/feature_map.yaml` to translate affected files into the
   owning feature and team, so the report speaks in product terms.
